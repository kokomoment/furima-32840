class User < ApplicationRecord
  ...
  validates :first_name_kana, presence: true, format: { with: /\A[ァ-ヶ]+\z/, message: 'Full-width characters'}
  validates :last_name_kana,  presence: true, format: { with: /\A[ァ-ヶ]+\z/, message: 'Full-width characters'}
